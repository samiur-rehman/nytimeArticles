...
describe('ArticleDetail Component', () => {
    test('renders the article details correctly', () => {
        const { getByText, getByAltText, getByRole } = render(<ArticleDetail selectedArticle={mockArticleDetail} />);
    ...
    test('renders correctly without ArticleDetails', () => {
        ...
        const { queryByAltText, queryByText, getByText } = render(<ArticleDetail selectedArticle={withoutArticleDetails} />);
